...
import LevelSelect from "@/components/games/season-dress/LevelSelect";
import GameBoard from "@/components/games/season-dress/GameBoard";
import type { LevelId } from "@/components/games/season-dress/levels";
import { playClick } from "@/lib/sounds";

export default function SeasonDressPage() {
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-4xl flex-col items-center px-4 py-6 sm:px-6 sm:py-10">
      <div className="flex w-full items-center justify-between gap-2">
        ...
        <h1 className="text-xl font-bold text-purple-700 sm:text-3xl">👕 แต่งตัวตามฤดู</h1>
